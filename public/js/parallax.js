...
(function() {
    ...
    $(function() {
      ...
      var PROPERTIES =               ['translateX', 'translateY', 'opacity', 'rotate', 'scale'],
        ...
        //   $.get("/api/examples").then(function(data){
        //     for (i=0;i<data.length;i++){
        //         var ID = data[i].id.toString() + "post";
        //         var container = $("<div class='container'>");
        //         var wrapper = $("<section id = " + ID +" class='wrapper'>")
        //         var rowClass = $("<div class='row'>").addClass(ID)
        //         var postt = $("<a class='postHolder'>").attr("href", "example/"+data[i].id.toString())
        //         var card = $("<div class='card blue-grey-darken-1><div class='crd-content white-text'><span class='card-title'>"+data[i].text+"</span></div></div>")
                
        //         $('body').append(container.append(wrapper.append(rowClass.append(postt.append(card)))));
